...
proc add*(parent, child: Construct; data: AllNeededData) =
  ...
  of ckQueryContinuation:
    var p = parent.queryContinuation
    case child.kind
    of ckQueryBody:
  ...
  of ckRefTypeExpression:
    var p = parent.refTypeExpression
    case child.kind
    of ckIdentifier:
      var c = child.identifier
      c.parentId = p.id; p.add c
  ...
  of ckParenthesizedPattern:
    var p = parent.parenthesizedPattern
    case child.kind
    of ckBinaryPattern:
      var c = child.binaryPattern
      c.parentId = p.id; p.add c
  ...
  of ckOrderByClause:
    var p = parent.orderByClause
    case child.kind
    of ckOrdering:
      var c = child.ordering
      c.parentId = p.id; p.add c
    else: assert false, couple & " plz impl for child: " & $child.kind
  of ckAwaitExpression:
  ...
  of ckCastExpression:
    ...
    of ckFunctionPointerType:
      var c = child.functionPointerType
      c.parentId = p.id; p.add c
    of ckGenericName:
      var c = child.genericName
      c.parentId = p.id; p.add c
  ...
  of ckLocalFunctionStatement:
    var p = parent.localFunctionStatement
    case child.kind
    of ckArrayType:
      var c = child.arrayType
      c.parentId = p.id; p.add c
  ...
  of ckQueryBody:
    ...
    of ckFromClause:
      ...
      c.parentId = p.id; p.add c
    of ckGroupClause:
      var c = child.groupClause
      c.parentId = p.id; p.add c
    of ckJoinClause:
      var c = child.joinClause
      c.parentId = p.id; p.add c
    of ckLetClause:
      var c = child.letClause
      c.parentId = p.id; p.add c
    of ckOrderByClause:
      var c = child.orderByClause
      c.parentId = p.id; p.add c
    of ckQueryContinuation:
      var c = child.queryContinuation
      c.parentId = p.id; p.add c
    of ckSelectClause:
      var c = child.selectClause
      c.parentId = p.id; p.add c
    of ckWhereClause:
      var c = child.whereClause
      c.parentId = p.id; p.add c
    else: assert false, couple & " plz impl for child: " & $child.kind
  of ckInterpolatedStringText:
    var p = parent.interpolatedStringText
    case child.kind
    of ckIdentifier:
      var c = child.identifier
      c.parentId = p.id; p.add c
  ...
  of ckUnaryPattern:
    ...
    of ckDeclarationPattern:
      ...
      c.parentId = p.id; p.add c
    of ckParenthesizedPattern:
      var c = child.parenthesizedPattern
      c.parentId = p.id; p.add c
    of ckRecursivePattern:
      var c = child.recursivePattern
      c.parentId = p.id; p.add c
  ...
  of ckSingleVariableDesignation:
    var p = parent.singleVariableDesignation
    case child.kind
    of ckIdentifier:
      var c = child.identifier
      c.parentId = p.id; p.add c
