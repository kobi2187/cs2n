...
template setMoreForObject(a: var untyped; id: UUID; data: AllNeededData; info: Info) =
  ...
  a.rawKind = info.rawKind
  a.parentRawKind = info.parentRawKind
...
proc createType*(info: Info; id: UUID; data: AllNeededData): Construct =
  ...
  "XmlNameAttribute", "XmlPrefix", "XmlProcessingInstruction", "XmlText", "XmlTextAttribute"
  , "BadDirectiveTrivia", "DefineDirectiveTrivia", "DocumentationCommentTrivia",
  "ElifDirectiveTrivia", "ElseDirectiveTrivia", "EndIfDirectiveTrivia",
  "EndRegionDirectiveTrivia", "ErrorDirectiveTrivia", "NullableDirectiveTrivia",
  ...
  of "LocalDeclarationStatement":
    ...
    result = Construct(kind: ckLocalDeclarationStatement,
        localDeclarationStatement: a)
  of "EnumDeclaration":
  ...
  of "IdentifierName":
    var a = extract(CsIdentifier, info)
    setMoreForObject(a,id,data,info)
    result = Construct(kind:ckIdentifier, identifier:a)
  ...
  of "ObjectCreationExpression":
    ...
    result = Construct(kind: ckObjectCreationExpression,
        objectCreationExpression: a)
  of "UsingDirective":
  ...
  of "ExplicitInterfaceSpecifier":
    ...
    result = Construct(kind: ckExplicitInterfaceSpecifier,
        explicitInterfaceSpecifier: a)
  ...
  of "ElementAccessExpression":
    ...
    result = Construct(kind: ckElementAccessExpression,
  ...
  of "ParenthesizedExpression":
    ...
    result = Construct(kind: ckParenthesizedExpression,
  ...
  of "OmittedArraySizeExpression":
    ...
    result = Construct(kind: ckOmittedArraySizeExpression,
        omittedArraySizeExpression: a)
  ...
  of "SimpleLambdaExpression":
    ...
    result = Construct(kind: ckSimpleLambdaExpression,
        simpleLambdaExpression: a)
  of "PostfixUnaryExpression":
    ...
    result = Construct(kind: ckPostfixUnaryExpression,
        postfixUnaryExpression: a)
  of "ArrayCreationExpression":
    ...
    result = Construct(kind: ckArrayCreationExpression,
        arrayCreationExpression: a)
  ...
  of "InterpolatedStringText":
    ...
    result = Construct(kind: ckInterpolatedStringText,
  ...
  of "ParenthesizedLambdaExpression":
    ...
    result = Construct(kind: ckParenthesizedLambdaExpression,
        parenthesizedLambdaExpression: a)
  of "TryStatement":
  ...
  of "ConstructorInitializer":
    ...
    result = Construct(kind: ckConstructorInitializer,
  ...
  of "TypeParameterConstraintClause":
    ...
    result = Construct(kind: ckTypeParameterConstraintClause,
        typeParameterConstraintClause: a)
  of "TypeConstraint":
  ...
  of "SingleVariableDesignation":
    ...
    result = Construct(kind: ckSingleVariableDesignation,
        singleVariableDesignation: a)
  of "InterpolatedStringExpression":
    ...
    result = Construct(kind: ckInterpolatedStringExpression,
  ...
  of "ImplicitArrayCreationExpression":
    ...
    result = Construct(kind: ckImplicitArrayCreationExpression,
        implicitArrayCreationExpression: a)
  of "WhileStatement":
  ...
  of "ConditionalAccessExpression":
    ...
    result = Construct(kind: ckConditionalAccessExpression,
        conditionalAccessExpression: a)
  of "SwitchStatement":
  ...
  of "MemberBindingExpression":
    ...
    result = Construct(kind: ckMemberBindingExpression,
        memberBindingExpression: a)
  ...
  of "AnonymousObjectMemberDeclarator":
    ...
    result = Construct(kind: ckAnonymousObjectMemberDeclarator,
        anonymousObjectMemberDeclarator: a)
  ...
  of "ClassOrStructConstraint":
    ...
    result = Construct(kind: ckClassOrStructConstraint,
        classOrStructConstraint: a)
  ...
  of "AnonymousMethodExpression":
    ...
    result = Construct(kind: ckAnonymousMethodExpression,
        anonymousMethodExpression: a)
  of "TupleExpression":
  ...
  of "AnonymousObjectCreationExpression":
    ...
    result = Construct(kind: ckAnonymousObjectCreationExpression,
        anonymousObjectCreationExpression: a)
  of "BracketedParameterList":
    ...
    result = Construct(kind: ckBracketedParameterList,
        bracketedParameterList: a)
  of "Event":
  ...
  of "LocalFunctionStatement":
    ...
    result = Construct(kind: ckLocalFunctionStatement,
        localFunctionStatement: a)
  ...
  of "CasePatternSwitchLabel":
    ...
    result = Construct(kind: ckCasePatternSwitchLabel,
        casePatternSwitchLabel: a)
  of "LabeledStatement":
  ...
  of "ParenthesizedVariableDesignation":
    ...
    result = Construct(kind: ckParenthesizedVariableDesignation,
        parenthesizedVariableDesignation: a)
  of "InterpolationFormatClause":
    ...
    result = Construct(kind: ckInterpolationFormatClause,
        interpolationFormatClause: a)
  of "Destructor":
  ...
  of "StackAllocArrayCreationExpression":
    ...
    result = Construct(kind: ckStackAllocArrayCreationExpression,
        stackAllocArrayCreationExpression: a)
  of "WhenClause":
  ...
  of "ForEachVariableStatement":
    ...
    result = Construct(kind: ckForEachVariableStatement,
        forEachVariableStatement: a)
  of "LetClause":
  ...
  of "ElementBindingExpression":
    ...
    result = Construct(kind: ckElementBindingExpression,
        elementBindingExpression: a)
  ...
  of "InterpolationAlignmentClause":
    ...
    result = Construct(kind: ckInterpolationAlignmentClause,
        interpolationAlignmentClause: a)
  ...
  of "ImplicitObjectCreationExpression":
    ...
    result = Construct(kind: ckImplicitObjectCreationExpression,
        implicitObjectCreationExpression: a)
  of "MemberAccessExpression":
    ...
    result = Construct(kind: ckMemberAccessExpression,
        memberAccessExpression: a)
  ...
  of "PositionalPatternClause":
    ...
    result = Construct(kind: ckPositionalPatternClause,
        positionalPatternClause: a)
  of "PrimaryConstructorBaseType":
    ...
    result = Construct(kind: ckPrimaryConstructorBaseType,
        primaryConstructorBaseType: a)
...
# ## end of some regex magic
  ...
  of "PropertyDeclaration":
    var a = extract(CsProperty, info);
    # a.id = some(id);
    # assert not a.typ.isEmptyOrWhitespace; a.src = data.sourceCode
    setMoreForObject(a, id, data, info)
    result = Construct(kind: ckProperty, property: a)
  of "FieldDeclaration":
    var a = extract(CsField, info);
    # a.id = some(id);
    # assert not a.typ.isEmptyOrWhitespace; a.src = data.sourceCode
    setMoreForObject(a, id, data, info)
...
>>>>>>> 54faa57b3a4cbaf076e4f54f43ef779823b548d3
  ...
  if not result.isNil:
    result.id = some(id)
    result.rawKind = info.rawKind
    result.parentRawKind = info.parentRawKind
