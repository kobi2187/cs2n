...
const noerrFile = "/home/kobi7/More_CS_Libs_and_Apps/no_add_errors.txt"
const toolongFile = "/home/kobi7/More_CS_Libs_and_Apps/toolong.txt"
let parentFolder = toolongFile.parentDir()
...
const numLines = 9
const startAfter = 0
const stopAfterFailures = none(int) #some(1000)
import hashes,sets
proc main() =
  var contents = noErrFile.readFile.splitLines.toHashSet()
  var toolong = toolongFile.readFile.splitLines.toHashSet()
